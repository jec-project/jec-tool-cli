...
/*
 * Provides tasks for building and testing the jec-tool-cli project.
 */
module.exports = function(grunt) {
  ...
  //--> Task: builds the "jec-tool-cli" project:
  grunt.registerTask("build", ["ts:build", "copy:main",
                               "copy:initTypes", "copy:buildTypesFile",
                               "clean:build"]);

  //--> Task: builds the "jec-tool-cli" API documentation:
